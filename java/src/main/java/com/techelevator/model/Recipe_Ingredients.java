...
public class Recipe_Ingredients {
    ...
    public Recipe_Ingredients(int ingredientId, String ingredientName, double ingredientAmount, String ingredientUnitType, String ingredientSystemOfMeasurement) {
